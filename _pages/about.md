...
郭金宇，电子科技大学信息与软件工程学院教师，剑桥大学联合培养博士，中国中文信息学会青年
...
目前已经以第一/通讯作者身份在国际知名会议期刊(如CCF A类会议、SCI一区期刊等)发表录用论文二十余篇。担任ACL、NeurIPS、ICML、WWW、TKDE等多个国际知名会议及期刊的审稿人，目前已经主持主研各类科研项目二十余项。
